...
public class Demo2FBRegister {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("input[name=firstname]")).sendKeys("Varshi");
		driver.findElement(By.cssSelector("[name=lastname]")).sendKeys("Tetali");
		...
		driver.findElement(By.cssSelector("#password_step_input")).sendKeys("welcome@123");
